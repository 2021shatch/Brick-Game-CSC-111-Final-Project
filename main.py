...
def main(): #Title screen window/menu is called with main() is called
    ...
    background = pygame.image.load('pics/menu.png') #background when called == image imported
...
def replay(score,lives): #Replay and Quit window that pops up when the user loses
    running = True
